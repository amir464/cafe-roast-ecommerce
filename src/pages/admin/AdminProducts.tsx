                ...
                <tr key={product.id}>
                  <td>
                    <div className="flex items-center gap-2.5">
                      <img className="h-[45px] w-[45px] rounded-lg object-cover" src={product.image} />
                      <b>{product.title}</b>
                    </div>
                  </td>
                  ...
                  <td>
                    <span
                      className={`inline-block rounded-full px-[9px] py-[5px] text-xs ${product.stock < 8 ? 'bg-[color-mix(in_srgb,var(--danger)_13%,var(--surface))] text-[var(--danger)]' : 'bg-[color-mix(in_srgb,var(--success)_13%,var(--surface))] text-[var(--success)]'}`}
                    >
